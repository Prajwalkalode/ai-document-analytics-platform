const STOP_WORDS = new Set([
  ...
  'as', 'an', 'are', 'at', 'by', 'from', 'or', 'be', 'was', 'were', 'but', 'not', 'they',
  'their', 'has', 'have', 'had', 'will', 'would', 'can', 'could', 'should', 'do', 'does',
  'did', 'which', 'what', 'when', 'where', 'how', 'all', 'any', 'if', 'so', 'no', 'yes',
  'about', 'been', 'more', 'other', 'some', 'such', 'them', 'than', 'then', 'there',
  'therefore', 'because', 'into', 'over', 'under', 'up', 'out', 'also', 'many', 'most',
  'just', 'only', 'new', 'use', 'used', 'using', 'may', 'each', 'while', 'after',
  'before', 'during', 'between', 'both', 'even', 'few', 'more', 'much', 'your', 'our',
  'you', 'we', 'he', 'she', 'them', 'his', 'her', 'its', 'who', 'whom', 'which', 'why',
]);
